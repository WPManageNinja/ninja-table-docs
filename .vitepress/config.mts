    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'Installation', link: '/guide/getting-started/how-to-install-and-activate-ninja-tables-plugin' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Drag & Drop Tables', link: '/guide/drag-drop-tables/how-to-create-your-first-drag-and-drop-table-with-ninja-tables' }
        ]
      },
      {
        text: 'Drag & Drop Settings',
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Google Sheets', link: '/guide/data-sources/google-sheets-integration' },
          { text: 'WooCommerce', link: '/guide/data-sources/woocommerce-integration' },
          { text: 'Fluent Forms', link: '/guide/data-sources/fluent-forms-integration' },
          { text: 'Custom SQL', link: '/guide/data-sources/create-table-from-custom-sql' },
          { text: 'WP Posts', link: '/guide/data-sources/create-wp-posts-table' },
          { text: 'Ninja Charts', link: '/guide/data-sources/ninja-charts-integration' }
        ]
      },
      {
        ...
        items: [
          ...
          { text: 'ACF Integration', link: '/guide/wordpress-integration/acf-field-integration-with-ninja-tables-column' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Data Filtering', link: '/guide/advanced-features/default-data-filtering-shortcode' }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Import CSV to Existing', link: '/guide/import-export/import-csv-file-to-an-existing-table' },
      ...
      },
      {
        ...
        items: [
          { text: 'Table Settings', link: '/guide/table-management/table-title-description-settings' },
