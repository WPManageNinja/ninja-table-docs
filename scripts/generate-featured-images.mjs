...
const FOOTER_TEXT = 'docs.ninjatables.com'
const DEFAULT_TITLE = 'Ninja Tables Documentation'
...
const EXCLUDE_DIRS_REL = ["guide/public"]
...
const SECTION_LABELS = {
  ...
  'drag-drop-settings': 'Drag & Drop Settings',
  'drag-drop-tables': 'Drag & Drop Tables',
  'import-export': 'Import & Export',
  'ninja-charts': 'Ninja Charts',
