---
title: "Image/File/Lightbox"
description: "Image/File/Lightbox"
---

# Image/File/Lightbox

A data table is only engaging when it has multimedia and not just plain text. This is why the Image/File/Lightbox data type is used for columns with images, videos, GIFs, icons, etc. in Ninja Tables.

And a lightbox is for when the image or the media needs to appear much clearer and bigger. When you click an image that has a lightbox format, it will open with a dark background.
...
This option includes **Image Only, Image Lightbox**, **Iframe Lightbox & Link to URL**.

> [!Note]
> Lightbox is a Pro feature

#### Image Only

Only image files can be added to the column’s field in this option. Both JPG & PNG file formats are supported.
This format won't open the image in a lightbox.
...
The link can be opened in a new window.

Here's how a table with Image Only and Iframe Lightbox looks like.

![Link to URL](/images/field-types/image-file-lightbox/link-to-url-4.webp)

Add an image with lightbox feature, use Iframe lightbox, or link a media in Ninja Tables easily.
