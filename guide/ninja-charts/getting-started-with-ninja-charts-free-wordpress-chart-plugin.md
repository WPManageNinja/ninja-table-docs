---
title: "Introduction: Getting Started with Ninja Charts"
description: "Introduction: Getting Started with Ninja Charts"
---

# Introduction: Getting Started with Ninja Charts
...
![Ninja Charts](/images/ninja-charts/getting-started-ninja-charts/1.-Charts-North-WordPress-06-03-2025-10-50.webp)
...
One of the most notable features of Ninja Charts is its ability to pull data from Ninja Tables and Fluent Forms to create beautiful [dynamic charts](/guide/ninja-charts/how-to-create-dynamic-charts-with-ninja-charts).

You can also create charts with [manual](/guide/ninja-charts/how-to-create-chart-manually-in-ninja-charts) data input.

<div class="video-embed">
  <iframe src="https://www.youtube.com/embed/v-mU6LIb7jQ" title="Getting Started with Ninja Charts Video" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
Simply [install and activate](/guide/getting-started/how-to-install-and-activate-ninja-tables-plugin) Ninja Charts and hit **Add New**.
...
![Use Ninja Charts](/images/ninja-charts/getting-started-ninja-charts/2.-Charts-North-WordPress-06-03-2025-11-33.webp)
