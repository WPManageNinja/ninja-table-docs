...
![Manage cells in Drag and Drop table](/images/drag-drop-settings/manage-cells-ninja-tables/1.-Manage-cells-in-table.webp)
...
![Manage table cells](/images/drag-drop-settings/manage-cells-ninja-tables/2.-Manage-table-cells.webp)
...
![highlight table column in Ninja Tables Drag and drop table](/images/drag-drop-settings/manage-cells-ninja-tables/4.-highlight-table-column-2.webp)
...
![merge table cells in Ninja Tables Drag and drop table](/images/drag-drop-settings/manage-cells-ninja-tables/5.-merge-data-table-cells.webp)
...
![customize and manage table rows in Ninja Tables Drag and Drop Table](/images/drag-drop-settings/manage-cells-ninja-tables/7.-customize-and-manage-table-tows.webp)
