...
![Upgrade button](/images/getting-started/upgrade-ninja-tables/3.-upgrade-to-pro-3.webp)

- Now go to your website’s WordPress Dashboard. Click on **Plugins** → **Installed Plugins** → **Add New** → **Upload Plugin**. 

![Upload Plugin](/images/getting-started/upgrade-ninja-tables/4.-upgrade-to-pro-4.webp)
