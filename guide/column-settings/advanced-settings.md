...
![advanced settings in columns](https://ninjatables.com/wp-content/uploads/2023/01/advanced-settings-3-1024x427.png)
Here you'll see several advanced options to customize the column- Extra Classes, Max Width, Header Text Align, Row Content Text Align, Filter, Sort, Column Background, and Column Text Color.
### Extra Classes
...
![css in advanced settings](https://ninjatables.com/wp-content/uploads/2023/09/css-in-advanced-settings-1024x459.png)
- This is how that particular column looks after Extra Classes were added.
![advanced CSS in column](https://ninjatables.com/wp-content/uploads/2023/01/advanced-settings-6-1024x301.png)
### Max Width
To define the maximum width of a particular table column, use this option. The width can be customized with either px or percentage.
### Header Text Align
...
This option is nearly the same as the previous one, except this time, it’s for content in row text.
You’ll have 3 options to choose from in a dropdown style. They are **Center**, **Left,** and **Right**.
### Header HTML Content
Provide content for the table column header if you want to show HTML content. This option will let you add icons or media to a column header.
### Filterable
If you disable this, then the column data will not be filterable at the front end.
### Sortable
...
### Column Background
You can set a particular column’s background color to be displayed on the table's front end.
![color customized column](https://ninjatables.com/wp-content/uploads/2023/09/color-customized-column-1024x317.png)
### Column Text Color
