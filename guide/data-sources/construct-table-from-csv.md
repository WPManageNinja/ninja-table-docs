...
![](/images/data-sources/construct-table-csv/1.-Construct-Table-From-CSV-1.webp)
...
![](/images/data-sources/construct-table-csv/2.-Construct-Table-From-CSV-2.webp)

- The table has been created here (See the below screenshot)

![](/images/data-sources/construct-table-csv/3.-Construct-Table-From-CSV-3.webp)
