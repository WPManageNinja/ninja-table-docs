---
title: "Ninja Charts Integration"
description: "Ninja Charts Integration"
---
...
![Create a New Chart](https://ninjatables.com/wp-content/uploads/2023/02/Ninja-Table-Chart-E-5.png)
- Put your** Chart Name** in the title **→** choose a **Chart** to **Renderer** engine **→** select your preferred **Chart** **Type** from the dashboard **→** then click on the **Next** button.
![Ninja Charts chart types](https://ninjatables.com/wp-content/uploads/2023/07/Ninja-Charts-chart-types-1024x560.png)
- From the **Source,** select **Ninja Tables**/**Fluent Forms** or **Manual Input**.
...
![Ninja Charts from Ninja Tables and Fluent Forms](https://ninjatables.com/wp-content/uploads/2023/03/Ninja-Charts-from-Ninja-Tables-and-Fluent-Forms-1-1024x413.png)
- Then, you’ll get the option to drag & drop the desired **columns** and click on the **Next** button.
![Create using Ninja-Charts](https://ninjatables.com/wp-content/uploads/2023/02/Ninja-Table-Chart-GIF.gif)
- Following that, you will see the prepared chart with **Formatting & preview** options. When you've finished making the necessary changes, click the **Next** button.
![edit wordpress charts](https://ninjatables.com/wp-content/uploads/2023/02/Ninja-Table-Chart-E-3-1024x496.png)
