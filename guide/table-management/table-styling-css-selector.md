...
![](https://ninjatables.com/wp-content/uploads/2022/09/06-scaled.webp)<figcaption class="wp-element-caption">Ninja Tables Advanced Settings</figcaption>
...
***#footable_parent_353 table.ninja_table_pro <strong>→** thead **>** tr > th</strong>*
...
<pre class="wp-block-preformatted">#footable_parent_353 table.ninja_table_pro thead tr th {
color: white;
font-size: 20px;
font-weight: bold;
font-style: italic;
...
<pre class="wp-block-preformatted">/* Select Table EVEN Rows */
...
![css selector in table](https://ninjatables.com/wp-content/uploads/2023/01/table-styling-css-selector-2.webp)<figcaption class="wp-element-caption">Applying custom styling in Ninja Tables</figcaption>
<p>
...
<pre class="wp-block-preformatted">#footable_parent_353 table.ninja_table_pro tr.footable-filtering form {
text-align: left;
}
</pre>
