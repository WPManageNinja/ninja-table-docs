...
![](/images/table-formatting/colspan-cell-merge/1.-add-colspan-01.webp)
...
![](/images/table-formatting/colspan-cell-merge/3.-Collapain-in-title-02.webp)

Here's an example of how merged table cells using "colspan" on the header looks like.

![colspan in table](/images/table-formatting/colspan-cell-merge/2.-rowspan.webp)

Go to **Table Configuration → Rendering Settings **and set your table to **Advanced Table (Legacy)**. This will enable you to apply the Cell Merge feature in your Ninja Table. See [Rendering Settings](https://ninjatables.com/docs/table-rendering-settings/).
