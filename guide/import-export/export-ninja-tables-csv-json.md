...
![Import - Export](/images/import-export/export-ninja-tables-csv/1.-01-3.webp)

- The **Export Data** option can be found below the **Import Data** option, on the **Import-Export** menu.

![Export Data](/images/import-export/export-ninja-tables-csv/2.-02-3.webp)

- There are two export file formats provided by Ninja Tables. **CSV & JSON,** now you just need to choose the option.

![File Format](/images/import-export/export-ninja-tables-csv/3.-03-3.webp)

- Lastly, save the table data on your computer by clicking on the **Export** button.

> [!Note]
> When you export a particular table in CSV format, you'll just export the table data. However, exporting the JSON file lets you export the Table Styling with the table data. 
