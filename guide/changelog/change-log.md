---
title: "Change Log"
description: "Stay updated with the latest improvements, new features, bug fixes, and performance enhancements in Ninja Tables."
---
...
```md [🔧 Improvements]
• All Accessibility Issues fixed so far
...
• We have worked over 1 month (200+ hours | 2 developers) to bring this version, we hope you will enjoy the features.
```
...
```md [🐛 Bug fixes]
• Fix a few CSS bugs for table cell text wrap issues
```
